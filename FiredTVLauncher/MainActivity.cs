...
{
    [IntentFilter(new[] { Intent.ActionMain }, Categories = new[] { Intent.CategoryDefault, Intent.CategoryHome })]
        ...
        void Setup(bool dateOnly = false)
        {
            RunOnUiThread(
                () =>
                {
                    ...
                    frameTopBar.SetBackgroundColor(
                        new Android.Graphics.Color(0, 0, 0, Settings.Instance.TopInfoBarBackgroundAlpha));
